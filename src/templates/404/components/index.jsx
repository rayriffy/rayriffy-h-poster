      ...
      <Flex justifyContent={`center`}>
        <Box width={[20 / 24, 16 / 24, 12 / 24, 8 / 24]}>
          <BorderedCard>
            ...
            <Box px={3} pt={1} pb={3}>
              <Text fontFamily={fontSets} fontSize={[18, 20, 22, 24]} fontWeight={600} pt={2}>Not found</Text>
              <Text fontFamily={fontSets} fontSize={[14, 15]} pt={2}>The page your're looking for is not found</Text>
            </Box>
          </BorderedCard>
        </Box>
      </Flex>
